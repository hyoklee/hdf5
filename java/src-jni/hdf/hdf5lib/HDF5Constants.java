...
public class HDF5Constants {
    ...
    private static native final int H5D_EFILE_ALLOW_ALL();

    private static native final int H5D_EFILE_REJECT_ABSOLUTE();

    private static native final int H5D_EFILE_REJECT_TRAVERSAL();
