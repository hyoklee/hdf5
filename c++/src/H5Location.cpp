...
///\param       curr_name - IN: Name of the existing object
///\param       same_loc  - IN: Group or root group ID, or H5L_SAME_LOC
...
///\brief       Renames an object at this location. - Deprecated in favor of moveLink()
...
///\brief       This is an overloaded member function, provided for convenience.
///             It differs from the above function in that it takes an
///             \c H5std_string for \a src and \a dst. - Deprecated in favor of moveLink()
//--------------------------------------------------------------------------
void
...
///\brief       This is an overloaded member function, provided for convenience.
///             It differs from the above function in that it takes
///             a reference to an \c H5std_string for \a grp_name.
...
///             the returned object type in text (char*) (Deprecated)
///\param       idx       - IN: Transient index of the object
...
///\brief       This is an overloaded member function, provided for convenience.
///             It differs from the above function because it also provides
///             the returned object type in text (H5std_string&) (Deprecated)
///\param       idx       - IN: Transient index of the object
///\param       type_name - OUT: Object type in text
///\return      Object type
///\exception   H5::FileIException/H5::GroupIException/H5::LocationException
