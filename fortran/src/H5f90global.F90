...
!> @}
  ...
  !DEC$ATTRIBUTES DLLEXPORT :: H5D_EFILE_ALLOW_ALL_F
  !DEC$ATTRIBUTES DLLEXPORT :: H5D_EFILE_REJECT_ABSOLUTE_F
  !DEC$ATTRIBUTES DLLEXPORT :: H5D_EFILE_REJECT_TRAVERSAL_F
...
!> @{
  ...
  INTEGER :: H5D_EFILE_ALLOW_ALL_F            !< H5D_EFILE_ALLOW_ALL
  INTEGER :: H5D_EFILE_REJECT_ABSOLUTE_F      !< H5D_EFILE_REJECT_ABSOLUTE
  INTEGER :: H5D_EFILE_REJECT_TRAVERSAL_F     !< H5D_EFILE_REJECT_TRAVERSAL
