...
if (${HDF5_PACKAGE_NAME}_PROVIDES_ZLIB_SUPPORT)
  if (NOT OFF)
    if (ON)
      ...
      find_dependency (ZLIB NAMES zlib CONFIG OPTIONAL_COMPONENTS )
    endif ()
  endif ()
endif ()
...
if (${HDF5_PACKAGE_NAME}_PROVIDES_SZIP_SUPPORT)
  if (NOT OFF)
    find_dependency (libaec OPTIONAL_COMPONENTS )
  endif ()
endif ()
...
# Version Strings
#-----------------------------------------------------------------------------
set (${HDF5_PACKAGE_NAME}_VERSION 2.2.0)
set (${HDF5_PACKAGE_NAME}_VERSION_STRING 2.2.0)
set (${HDF5_PACKAGE_NAME}_VERSION_MAJOR  2.2)
...
if (NOT TARGET "hdf5")
  ...
  if (${HDF5_PACKAGE_NAME}_PROVIDES_STATIC_LIBS AND ${HDF5_PACKAGE_NAME}_PROVIDES_SHARED_LIBS)
    include ("${PACKAGE_PREFIX_DIR}/cmake/hdf5_static-targets.cmake" OPTIONAL RESULT_VARIABLE _hdf5_static_loaded)
  ...
  if (${HDF5_PACKAGE_NAME}_PROVIDES_JAVA)
    include ("${PACKAGE_PREFIX_DIR}/cmake/hdf5_java-targets.cmake" OPTIONAL RESULT_VARIABLE _hdf5_java_loaded)
